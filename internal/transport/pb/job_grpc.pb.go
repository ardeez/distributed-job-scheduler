...
const (
	JobService_SubmitJob_FullMethodName    = "/herschel.v1.JobService/SubmitJob"
	JobService_GetJobStatus_FullMethodName = "/herschel.v1.JobService/GetJobStatus"
	JobService_ListJobs_FullMethodName     = "/herschel.v1.JobService/ListJobs"
	JobService_CancelJob_FullMethodName    = "/herschel.v1.JobService/CancelJob"
	JobService_ListDeadJobs_FullMethodName = "/herschel.v1.JobService/ListDeadJobs"
	JobService_RetryDeadJob_FullMethodName = "/herschel.v1.JobService/RetryDeadJob"
)
...
type JobServiceClient interface {
	...
	RetryDeadJob(ctx context.Context, in *RetryDeadJobRequest, opts ...grpc.CallOption) (*RetryDeadJobResponse, error)
}
...
func (c *jobServiceClient) RetryDeadJob(ctx context.Context, in *RetryDeadJobRequest, opts ...grpc.CallOption) (*RetryDeadJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RetryDeadJobResponse)
	err := c.cc.Invoke(ctx, JobService_RetryDeadJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedJobServiceServer) RetryDeadJob(context.Context, *RetryDeadJobRequest) (*RetryDeadJobResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RetryDeadJob not implemented")
}
...
func _JobService_RetryDeadJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetryDeadJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServiceServer).RetryDeadJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobService_RetryDeadJob_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServiceServer).RetryDeadJob(ctx, req.(*RetryDeadJobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var JobService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "herschel.v1.JobService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RetryDeadJob",
			Handler:    _JobService_RetryDeadJob_Handler,
		},
	},
